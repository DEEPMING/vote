...
import com.example.vote.mapper.ParticipatorMapper;
...
public class ParticipatorController {
    ...
    @RequestMapping("participator/index")
    public String getParticipatorPage(HttpServletRequest request, Model model){
        logger.info("访问participator/index");
        ...
        return "participator/index.html";
    }


    //安全退出功能
    @RequestMapping("participator/safeOut")
    @ResponseBody
    ...
    //投票
    @RequestMapping("participator/toupiao")
    @ResponseBody
    public String toupiao(HttpServletRequest request){
        String target = request.getParameter("target");

        participatorMapper.toupiao(target);
        return "success";
    }
}
